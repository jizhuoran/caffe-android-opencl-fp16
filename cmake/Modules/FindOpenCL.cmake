...
ELSE (APPLE)
	...
	ELSE (WIN32)
		...
		# to the library
		FIND_PATH(OPENCL_INCLUDE_DIRS CL/cl.h PATHS ${_OPENCL_INC_CAND} "/usr/local/cuda/include" "/usr/local/cuda-10.0/include" "/opt/AMDAPP/include" "/opt/rocm/opencl/include" ENV OpenCL_INCPATH)
		FIND_PATH(_OPENCL_CPP_INCLUDE_DIRS CL/cl.hpp PATHS ${_OPENCL_INC_CAND} "/usr/local/cuda/include" "/usr/local/cuda-10.0/include" "/opt/AMDAPP/include" "/opt/rocm/opencl/include" ENV OpenCL_INCPATH)
	ENDIF (WIN32)
